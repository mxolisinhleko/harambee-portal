                ...
                <div class="card custom contact-card">
                    <div class="card-body">
                        ...
                        <div class="user-detail">
                            ...
                            <ul class="info-list">
                                <li><span><?php echo e(__('Phone')); ?> : </span><?php echo e(!empty($maintainer->user)?$maintainer->user->phone_number:'-'); ?> </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cmm9wxppgc5y/public_html/harambee/portal/resources/views/maintainer/index.blade.php ENDPATH**/ ?>