        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('flutterwave_public_key',__('Public Key'),array('class'=>'form-label'))); ?>
                        ...
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('flutterwave_secret_key',__('Secret Key'),array('class'=>'form-label'))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cmm9wxppgc5y/public_html/harambee/portal/resources/views/settings/payment.blade.php ENDPATH**/ ?>