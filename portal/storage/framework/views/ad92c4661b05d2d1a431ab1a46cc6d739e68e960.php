...
<aside class="codex-sidebar sidebar-<?php echo e($settings['sidebar_mode']); ?>">
    ...
    <div class="codex-menuwrapper">
        <ul class="codex-menu custom-scroll" data-simplebar>
            ...
            <?php if(Gate::check('manage types') || Gate::check('manage notification')): ?>
                <li class="cdxmenu-title">
                ...
                <li class="menu-item <?php echo e(in_array($routeName, ['notification.index']) ? 'active' : ''); ?>">
...
<!-- sidebar end-->
<?php /**PATH /home/cmm9wxppgc5y/public_html/harambee/portal/resources/views/admin/menu.blade.php ENDPATH**/ ?>