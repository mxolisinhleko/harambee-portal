                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create invoice payment')): ?>
                    ...
                    <?php else: ?>
                        <a class="btn btn-primary float-end me-2 customModal" href="#" data-size="md"
                            ...
                            data-url="<?php echo e(route('invoice.reminder', $invoice->id)); ?>"
                        ...
                        <ul class="nav nav-tabs border-0 mb-15">
                            ...
                            <?php if(
                                ...
                                <li><a class="btn" data-bs-toggle="tab"
                                        href="#flutterwave_payment"><?php echo e(__('Flutterwave')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                            ...
                            <div class="invoice-user">
                                ...
                                <div class="right-user">
                                    <ul class="detail-list">
                                        ...
                                        <li><?php echo e(__('Invoice No')); ?>: <span><?php echo e(invoicePrefix() . $invoice->invoice_id); ?>

                                            </span>
                                        </li>
                                        <li><?php echo e(__('Invoice Month')); ?>:
                                            <span> <?php echo e(date('F Y', strtotime($invoice->invoice_month))); ?> </span>
                                        </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cmm9wxppgc5y/public_html/harambee/portal/resources/views/invoice/show.blade.php ENDPATH**/ ?>